...
export const gridItems = [
...

  {
    ...
    className: "lg:col-span-2 md:col-span-3 md:row-span-2",
    imgClassName:
      "absolute -right-10 bottom-0 top-0 lg:-right-16 lg:bottom-0 lg:top-12 md:w-100 w-60 md:h-100 lg:scale-[2.2]",
  ...
  },
  {
    ...
    imgClassName: "",
    titleClassName:
      "justify-center md:justify-start lg:justify-center items-center",
    img: "",
    spareImg: "",
  },
];
...
export const projects = [
  ...
  },
  {
    id: 1,
    title: "Flow",
    des: "Multi-agent Claude pipeline that turns a Jira ticket into reviewed, secured code",
    img: "/flow.png",
    iconLists: ["/fastapi.svg", "/ts.svg", "/anthropic.svg", "/jira.svg", "/argo.svg", "/githubactions.svg"],
  ...
  },
  {
    ...
    des: "An world hardest game clone",
    img: "/hardestGame.png",
    iconLists: ["/java.svg"],
